...
ResponseAnnouncePacket::ResponseAnnouncePacket(boost::asio::streambuf buffer,int32_t transactionID) {
    if(buffer.size() < 20) {
...
int32_t ResponseAnnouncePacket::action() const {
    return action_;
}

int32_t ResponseAnnouncePacket::transactionId() const {
    return transactionID_;
}

int32_t ResponseAnnouncePacket::interval() const {
    return interval_;
}

int32_t ResponseAnnouncePacket::leechers() const {
    return leechers_;
}

int32_t ResponseAnnouncePacket::seeders() const {
    return seeders_;
}

const std::vector<ResponseAnnouncePacket::Seed> &ResponseAnnouncePacket::peers() const {
    return peers_;
}
